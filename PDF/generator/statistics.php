...
$data_array=[];
 ...
 $qry = " SELECT a.name, a.code, b.sale_id,b.quantity,c.sale_id,c.sale_date FROM tbl_drug a, tbl_sale_drug b, tbl_sale c WHERE a.drug_id = b.drug_id AND b.sale_id = c.sale_id AND c.sale_date BETWEEN '$year-01-01' AND '$year-12-31' ORDER BY b.quantity DESC ";
...
$pdf->SetTitle('Annual Statistics Report');
...
<h2>PRODUCTS SALE STATISTICS FOR $year</h2>
