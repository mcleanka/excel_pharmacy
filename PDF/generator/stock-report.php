...
//START MY SCRIPTS
require '../../init.php';
$currentdate = strtoupper(date('jS F, Y'));
$data_array=[];
...
$array = [$dname,$dcode,$quantity,$date];
...
<h2>INVENTORY REPORT AS AT $currentdate</h2>
<br/>
EOF;
...
// column titles
$header = array('PRODUCT NAME', 'PRODUCT CODE', 'QUANTITY', 'LAST RESTOCK');
...
//Close and output PDF document
$pdf->Output("STOCK_REPORT_".$currentdate.".pdf", 'D');
